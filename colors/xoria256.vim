...
hi Cursor	cterm=none	ctermfg=234	ctermbg=214	gui=none	guifg=#1c1c1c	guibg=#ffaf00
...
hi WarningMsg	cterm=bold	ctermfg=196	ctermbg=none	gui=bold	guifg=#ff0000	guibg=none
hi ModeMsg	cterm=bold	ctermfg=fg	ctermbg=none	gui=bold	guifg=fg	guibg=none
hi MoreMsg	cterm=bold	ctermfg=250	ctermbg=none	gui=bold	guifg=#bcbcbc	guibg=none
hi Question	cterm=bold	ctermfg=113	ctermbg=none	gui=bold	guifg=#87df7f	guibg=none
...
hi FoldColumn	cterm=none	ctermfg=248	ctermbg=58	gui=none	guifg=#a8a8a8	guibg=none
hi SignColumn	cterm=none	ctermfg=248	ctermbg=none	gui=none	guifg=#a8a8a8	guibg=none

hi Directory	cterm=none	ctermfg=39	ctermbg=none	gui=none	guifg=#00afff	guibg=none
...
hi SpecialKey	cterm=none	ctermfg=77	ctermbg=none	gui=none	guifg=#5fdf5f	guibg=none
...
hi VisualNOS	cterm=bold,underline ctermfg=247 ctermbg=none	gui=bold,underline guifg=#9e9e9e guibg=none

hi Comment	cterm=none	ctermfg=244	ctermbg=none	gui=none	guifg=#808080	guibg=none
""" COLD
hi Constant	cterm=none	ctermfg=187	ctermbg=none	gui=none	guifg=#dfdfaf	guibg=none
""" COLD-DARK
"hi Constant	cterm=none	ctermfg=223	ctermbg=none	gui=none	guifg=#ffdfaf	guibg=none
""" NEUTRAL
"hi Constant	cterm=none	ctermfg=229	ctermbg=none	gui=none	guifg=#ffffaf	guibg=none
""" WARM
"hi Constant	cterm=none	ctermfg=222	ctermbg=none	gui=none	guifg=#ffdf87	guibg=none
"hi String	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Error	cterm=none	ctermfg=196	ctermbg=none	gui=none	guifg=#ff0000	guibg=none
""" COLD
"hi Identifier	cterm=none	ctermfg=115	ctermbg=none	gui=none	guifg=#87dfaf	guibg=none
""" NEUTRAL
"hi Identifier	cterm=none	ctermfg=114	ctermbg=none	gui=none	guifg=#87df87	guibg=none
""" WARM
hi Identifier	cterm=none	ctermfg=150	ctermbg=none	gui=none	guifg=#afdf87	guibg=none
hi Ignore	cterm=none	ctermfg=238	ctermbg=none	gui=none	guifg=#444444	guibg=none
hi Number	cterm=none	ctermfg=180	ctermbg=none	gui=none	guifg=#dfaf87	guibg=none
"hi Number	cterm=none	ctermfg=222	ctermbg=none	gui=none	guifg=#ffaf87	guibg=none
"hi Number	cterm=none	ctermfg=215	ctermbg=none	gui=none	guifg=#ffaf87	guibg=none
...
hi PreProc	cterm=none	ctermfg=182	ctermbg=none	gui=none	guifg=#dfafdf	guibg=none
"hi PreProc	cterm=none	ctermfg=218	ctermbg=none	gui=none	guifg=#ffafdf	guibg=none
""" LIGHT
"hi Special	cterm=none	ctermfg=174	ctermbg=none	gui=none	guifg=#ffafaf	guibg=none
""" DARK
hi Special	cterm=none	ctermfg=174	ctermbg=none	gui=none	guifg=#df8787	guibg=none
"hi Special	cterm=none	ctermfg=114	ctermbg=none	gui=none	guifg=#87df87	guibg=none
"hi SpecialChar	cterm=		ctermfg=	ctermbg=	gui=		guifg=		guibg=
hi Statement	cterm=none	ctermfg=74	ctermbg=none	gui=none	guifg=#5fafdf	guibg=none
"hi Statement	cterm=none	ctermfg=75	ctermbg=none	gui=none	guifg=#5fafff	guibg=none
hi Todo		cterm=none	ctermfg=0	ctermbg=184	gui=none	guifg=#000000	guibg=#dfdf00
"hi Type		cterm=none	ctermfg=153	ctermbg=none	gui=none	guifg=#afdfff	guibg=none
hi Type		cterm=none	ctermfg=146	ctermbg=none	gui=none	guifg=#afafdf	guibg=none
hi Underlined	cterm=underline	ctermfg=39	ctermbg=none	gui=underline	guifg=#00afff	guibg=none

"hi htmlBold	cterm=		ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=bold
"hi htmlBoldItalic cterm=	ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=bold,italic
"hi htmlBoldUnderline cterm=	ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=bold,underline
"hi htmlBoldUnderlineItalic cterm= ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=bold,underline,italic
"hi htmlItalic	cterm=		ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=italic
"hi htmlUnderline cterm=	ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=underline
"hi htmlUnderlineItalici cterm=	ctermbg=0	ctermfg=15	guibg=none	guifg=fg	gui=underline,italic
...
if v:version >= 700
  ...
  hi PmenuThumb cterm=none	ctermfg=234	ctermbg=252	gui=none	guifg=#1c1c1c	guibg=#d0d0d0
  ...
  hi TabLineSel	cterm=bold	ctermfg=fg	ctermbg=none	gui=bold	guifg=fg	guibg=none
